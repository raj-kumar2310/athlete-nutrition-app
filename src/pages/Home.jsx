...
import { Dumbbell, Trophy, Zap, Heart, Scale, Calculator, Sun, Moon, Activity } from 'lucide-react'
...
const tabs = [
  ...
  { id: 'calculator',  label: 'Nutrition Calculator', sublabel: 'Calories burned & intake',            icon: Calculator,  color: '#CE93D8', path: '/calculator',  gradient: 'linear-gradient(135deg, #CE93D8, #AB47BC)' },
  { id: 'injury', label: 'Injury Assistant', sublabel: 'AI Physio • Rehab • Nutrition', icon: Activity, color: '#FF3057', path: '/injury', gradient: 'linear-gradient(135deg, #FF3057, #FF6B6B)' },
              ...
              {[
                ...
                <div key={stat.label} style={{
                  ...
                  <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 26, fontWeight: 900, color: stat.color }}>
                    {stat.value}
                    <span style={{ fontSize: 14, color: text3 }}> {stat.unit}</span>
                  </div>
          ...
          {tabs.map((tab, i) => {
            ...
            return (
              <motion.button
                ...
                style={{
                  background: bg2,
                  border: `1px solid ${cardBorder(tab.color)}`,
              ...
              >
                ...
                <div style={{
                  ...
                  background: `radial-gradient(circle, ${tab.color}18 0%, transparent 70%)`,
                  pointerEvents: 'none'
                }} />
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: 14, boxShadow: `0 4px 16px ${tab.color}33`
                }}>
